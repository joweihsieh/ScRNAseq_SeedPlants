...
df <- read.csv("/Users/joweihsieh/Dropbox/YCL/Single_Cell_Cla/LCM_proteomes/20250610/1140713-1140718_Ptr-B_20250609_Peptide Quant Report.csv")
colnames(df)[c(8:13)] <- c("Bio2_O", "Bio2_I", "Bio3_O", "Bio3_I", "Bio4_O", "Bio4_I")


Ptr_Proteomes <- df[,c(1,4,7:13)]
...
for (bio in bio_cols) {
  ...
  result <- process_single_bio_analysis(
    ...
    output_dir_prefix = "20250610_output_Ptr"
  )
