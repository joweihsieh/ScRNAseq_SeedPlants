...
#    input:
#        orthoMCL_txt = lambda wildcards: config["OTHER_DATA_PATH"] + "/20220000_Single_cell_rawdata/20210130_Geneclustering_OrthoMCL/all.group",
...
#    params:
#        other_data_path = config["OTHER_DATA_PATH"]
#    script:
